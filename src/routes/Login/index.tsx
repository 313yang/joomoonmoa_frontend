...
import { useNaverSolutionTokenAction } from "@/libs/store/useNaverSolutionToken";
...
const Login = () => {
  ...
  const { setNaverSolutionToken } = useNaverSolutionTokenAction();
